...
22 | 21 ocupado (44) → tenta 22
6 | 3 ocupado (49) → 4 ocupado (27) → 5 ocupado (97) → 6
...
V com 11 vértices, E com 15 arestas:
...
Não. Arestas paralelas são duas ou mais arestas distintas com o mesmo par de extremos.
Em G cada par de vértices é ligado por, no máximo, uma aresta; logo não há arestas paralelas.

### B) Há vértices isolados?

Não. Um vértice isolado tem grau 0 (nenhuma aresta incidente). Em G todos
os vértices têm grau ≥ 2, portanto nenhum é isolado.
...
sempre par. Aqui Σ d(v) = 15 × 5 = 75, que é ímpar.
...
Comparar invariantes — nº de vértices, nº de arestas e sequência
...
G1 e G2 NÃO são isomorfos. Ambos têm 6 vértices e 10 arestas,
...
Em Kn cada par de vértices distintos é ligado por exatamente uma aresta, logo:
...
Um grafo conexo é Euleriano (ppercurso fechado que usa cada aresta exatamente uma vez)
se, todos os vértices têm grau par. Em G os vértices v2, v3, v4 e v5 têm grau 3 (ímpar).
