...
* * 1. Considere uma aplicação que utiliza uma tabela hash para armazenar*
...
public class Ex03_Rehashing {
    ...
    public static int hash(int chave, int n) {

        return chave % n;
    }

    public static int rehashing(int[] tabHash, int chave) {
    ...
    public static void main(String[] args) {
        ...
        for (int chave : chaves) {
            ...
            System.out.println("Chave: " + chave + " -> Hash: " + indice);
            ...
            if (tabHash[indice] == -1) {
                ...
                System.out.println("Colisao! Chave " + chave + " tentou ocupar o slot " + indice);
                ...
                if (novoIndice != -1) {
                    ...
                    System.out.println("Chave " + chave + " armazenada no slot " + novoIndice);

                } else {

                    System.out.println("Tabela cheia. " + "Nao foi possivel inserir: " + chave);
                }
            }
